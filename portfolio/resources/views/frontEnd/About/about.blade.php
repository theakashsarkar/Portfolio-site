            ...
            <div class="row about-content mb-lg-5">
                <div class="col-lg-6 pr-md-5">
                    <div class="image-block">
                        <img src="{{ asset('/') }}/frontEnd/images/me.png" class="img-fluid myphoto" alt="my photo" />
                        <img src="{{ asset('/') }}/frontEnd/images/cross.png" class="img-fluid pos" alt="dots" />
                    </div>
                </div>
                <div class="col-lg-6 info pl-lg-5 mt-lg-0 mt-5 pt-lg-0 pt-3 align-center">
                    ...
                    <img src="{{ asset('/') }}/frontEnd/images/signature.png" class="img-fluid signature" width="300px" alt="my photo" />
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 content" data-id="id-1" data-type="cat-item-1">
                    <span class="image-block">
                        ...
                        <a class="image-zoom" href="#img">
                            <img src="{{ asset('/') }}/frontEnd/images/alexandra.jpg" class="img-fluid w3layouts agileits"
                                alt="portfolio-img">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 content mt-sm-0 mt-4" data-id="id-2" data-type="cat-item-2">
                    <span class="image-block">
                        <div class="content-overlay"></div>
                        <a class="image-zoom" href="#img">
                            <img src="{{ asset('/') }}/frontEnd/images/bench.jpg" class="img-fluid w3layouts agileits" alt="portfolio-img">
                            <div class="content-details fadeIn-bottom">
                                <h3 class="content-title">This is a title</h3>
                                <p class="content-text">This is a short description</p>
                            </div>
